        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              {notificationsOpen && (
                <div className="absolute top-full right-0 mt-2 w-80 bg-white/95 backdrop-blur-2xl rounded-2xl shadow-3xl border border-white/20 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300">
                  {/* Header */}
